...
#define PIN_SCE   P1_5 // SCE - Chip select, pin 3 on LCD.
#define PIN_RESET P1_4 // RST - Reset, pin 4 on LCD.           
#define PIN_DC    P1_3 // DC - Data/Command, pin 5 on LCD.     
#define PIN_SDIN  P3_6 // DN(MOSI) - Serial data, pin 6 on LCD.
#define PIN_SCLK  P3_5 // SCLK - Serial clock, pin 7 on LCD.   
#define PIN_BL    P1_2 // LED - Backlight LED, pin 8 on LCD.   
